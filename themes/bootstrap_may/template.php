...
//    dpm(drupal_get_title(), 'drupal_get_title() in bootstrap_may_process_html');
//    //dpm($variables, '$variables in process_html');
//    dpm($variables['head_title'], 'head_title in bootstrap_may_process_html');
//    dpm($variables['head_title_array'], 'head_title_array in bootstrap_may_process_html');
...
//    dpm(drupal_get_title(), 'drupal_get_title() in bootstrap_may_preprocess_html');
//    //dpm($variables, '$variables in process_html');
//    dpm($variables['head_title'], 'head_title in bootstrap_may_preprocess_html');
//    dpm($variables['head_title_array'], 'head_title_array in bootstrap_may_preprocess_html');
