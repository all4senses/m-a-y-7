      ...
      foreach($variables['view']->result as $media) {
        ...
        $out .= '<div class="masonry-item" style="background:' . $media->i_maincolor . ';">'
                ...
                . '<div class="info">'
                  ...
                  . '<div class="link">' . l('I', 'https://www.instagram.com/p/' . $media->shortcode, array('absolute' => TRUE, 'attributes' => array('title' =>  'Instagram page: ' . $media->shortcode, 'target' => '_blank'))) . '</div>'
